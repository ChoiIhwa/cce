...
public class JumunDetail {
	...
	public JumunDetail(int j_no, int a_no, int p_no, int jd_price, Date jd_date, int jd_quantity, int jd_type) {
		super();
		this.j_no = j_no;
		this.a_no = a_no;
		this.p_no = p_no;
	...
	public String toString() {
		return "JumunDetail [j_no=" + j_no + ", a_no=" + a_no + ", p_no=" + p_no + ", jd_price=" + jd_price
				+ ", jd_date=" + jd_date + ", jd_quantity=" + jd_quantity + ", jd_type=" + jd_type + "]";
	}
